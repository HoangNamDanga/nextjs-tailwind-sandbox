...
const cities = ["Hà Nội", "Hải Phòng", "TP.HCM", "Vũng Tàu", "Bình Định"];
const CustomSelectBox = () => {
  const [selectedCity, setSelectedCity] = useState("Hà Nội");
    ...
    <>
      <div className="bg-gray-100 flex flex-col justify-center items-center w-64 relative z-30">
        ...
        <div
          ...
          } transition-all duration-200 overflow-hidden absolue top-16 left-0`}
        >
          {cities.map((item) => (
            <div
              key={item}
              ...
              className={`flex justify-start items-center gap-x-2 px-2 py-1 hover:bg-orange-100 cursor-pointer ${selectedCity === item ? "bg-orange-100" : ""}`}
            >
              <AiOutlineCheck
